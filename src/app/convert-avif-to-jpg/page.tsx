...
export const metadata: Metadata = {
  title: "Convert AVIF to JPG Online Free | ResizePixel Online",
  description: "Convert your AVIF images to highly compatible JPG/JPEG format online for free. Adjust quality and compress file size locally.",
  keywords: ["convert avif to jpg", "avif to jpg online", "change avif to jpeg", "avif to jpeg converter"],
};

export default function ConvertAvifToJpgPage() {
  const faqSchema = {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://resizepixel.online/convert-avif-to-jpg"
      }
    ]
  };
    ...
    <div className="border-t border-white/5 pt-10 mt-10 space-y-8 text-left">
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-400 font-light leading-relaxed">
          Quickly convert AVIF photos to JPG using our secure offline-first tool. Customize the quality index to compress or preserve resolution as needed.
        </p>
        <p className="text-xs text-gray-400 font-light leading-relaxed">
          While AVIF offers extremely high compression ratios, JPG is the universal standard for sharing via email, uploading to official portals, and displaying on older browsers.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-white/5 bg-white/[0.01] space-y-3">
          ...
          <p className="text-xs text-gray-400 font-light leading-relaxed">
            Preparing downloaded next-generation AVIF images for forms, applications, or submission portals that only accept classic `.jpg` or `.jpeg` extension uploads.
          </p>
        </div>
      </div>
  ...
  return (
    <ConverterWorkspace
      ...
      subtitle="Transform next-generation AVIF formats into universally supported JPG/JPEG files. Private and secure."
      pageSuffix="AVIF to JPG"
